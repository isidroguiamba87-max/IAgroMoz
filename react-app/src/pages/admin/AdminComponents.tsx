...
export function Badge({ status }) {
  const map = {
    ...
    AWAITING_CONFIRMATION: ['bg-orange-100 text-orange-700', 'Ag. Confirmação'],
    PROCESSING: ['bg-cyan-100 text-cyan-700', 'Em Processamento'],
    IN_TRANSIT: ['bg-purple-100 text-purple-700', 'A Caminho'],
